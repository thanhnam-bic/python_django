    ...
    try:
        ...
        for field in required_fields:
            if field not in data or not data[field]:
                return JsonResponse({
                    'thanh_cong': False,
                    'thong_bao': f'Thiếu thông tin bắt buộc: {field}',
                    'du_lieu': None
                }, status=400)
        ...
        if 'danh_muc' in data and data['danh_muc']:
            try:
                ...
                return JsonResponse({
                    'thanh_cong': False,
                    'thong_bao': f'Danh mục "{data["danh_muc"]}" không tồn tại',
                    'du_lieu': None
                }, status=400)
        ...
        if 'ma_nhan_vien' in data and data['ma_nhan_vien']:
            try:
                ...
                return JsonResponse({
                    'thanh_cong': False,
                    'thong_bao': f'Nhân viên "{data["ma_nhan_vien"]}" không tồn tại',
                    'du_lieu': None
                }, status=400)
        ...
        if 'nha_san_xuat' in data and data['nha_san_xuat']:
            try:
                ...
                return JsonResponse({
                    'thanh_cong': False,
                    'thong_bao': f'Nhà sản xuất "{data["nha_san_xuat"]}" không tồn tại',
                    'du_lieu': None
                }, status=400)
        ...
        if 'nha_cung_cap' in data and data['nha_cung_cap']:
            try:
                ...
                return JsonResponse({
                    'thanh_cong': False,
                    'thong_bao': f'Nhà cung cấp "{data["nha_cung_cap"]}" không tồn tại',
                    'du_lieu': None
                }, status=400)
        ...
        return JsonResponse({
            'thanh_cong': False,
            'thong_bao': f'Lỗi khi tạo tài sản: {str(e)}',
            'du_lieu': None
        }, status=500)
